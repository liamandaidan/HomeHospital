/**
 * This component will check the values from the create new practitioner form and
 * send a list of errors if any of the values are invalid
 * @param {*} values values received from the create new practitioner form
...
export default function validatePracInfo(values) {
  ...
  /**
   * checks if the practioner id entered matches
   */
  ...
  /**
   * checks if the facility id entered matches
   */
